# Relatório Executivo - Sizing de Infraestrutura para Inferência

**Modelo:** DeepSeek-V3.2  
**Servidor:** dgx-b300  
**Data:** 2026-02-12 18:50:26  
...
| **Energia (Compute + Storage)** | **70.8 kW** (58.0 + 12.8) |
| **Rack (Compute + Storage)** | **54U** (40 + 14) |
| **Storage total** | **37.05 TB** |
| Storage (modelo) | 9.35 TB |
| Storage (cache) | 5.55 TB |
| Storage (logs) | 18.10 TB |
| IOPS (pico R/W) | 75,000 / 3,000 |
| Throughput (pico R/W) | 15.8 / 0.0 GB/s |
| Arquitetura HA | N+1 |
...
|----------|--------|-------------|-------|
| Nós DGX | 2 | 4 | 5 |
| Energia Total (kW) | 41.8 | 70.8 | 85.3 |
| Rack Total (U) | 34 | 54 | 64 |
| Storage (TB) | 27.6 | 37.0 | 79.7 |
| IOPS pico (R) | 75,000 | 75,000 | 100,000 |
| Throughput pico (R) | 23.5 GB/s | 15.8 GB/s | 36.3 GB/s |
...
- Requer 37.0 TB de storage (netapp_a_series, incluindo margem de capacidade)
  - IOPS pico: 75,000 leitura / 3,000 escrita
  - Throughput pico: 15.8 GB/s leitura / 0.0 GB/s escrita
