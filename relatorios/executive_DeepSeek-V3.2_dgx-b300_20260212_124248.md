...
(58.0 kW, 40U rack, 33.1 TB storage) 
...
**Análise Storage:** Volumetria recomendada 25.6 TB (base: 17.1 TB) para operação steady-state. 
...
| **Storage total** | **33.09 TB** |
| Storage (modelo) | 9.35 TB |
| Storage (cache) | 5.55 TB |
| Storage (logs) | 18.10 TB |
| IOPS (pico R/W) | 75,000 / 3,000 |
| Throughput (pico R/W) | 211.8 / 0.0 GB/s |
| Arquitetura HA | N+1 |
...
**Análise Storage:** 33.1 TB recomendado (base: 22.1 TB) com margem de capacidade. 
...
**Análise Storage:** 74.8 TB recomendado (base: 49.9 TB) com margem ampla para máxima resiliência. 
...
| Storage (TB) | 25.6 | 33.1 | 74.8 |
| IOPS pico (R) | 75,000 | 75,000 | 100,000 |
| Throughput pico (R) | 327.7 GB/s | 211.8 GB/s | 510.6 GB/s |
...
- Requer 33.1 TB de storage (profile_default, incluindo margem de capacidade)
  - IOPS pico: 75,000 leitura / 3,000 escrita
  - Throughput pico: 211.8 GB/s leitura / 0.0 GB/s escrita
